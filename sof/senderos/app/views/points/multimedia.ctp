	...
	if($show === 'yes')
	{
		if($pointdocument['Document']['type'] === $what) //if an image
		{
			...
			else if($pointdocument['Document']['type'] === 'sound') //if a sound
			{
				...
				$imagesdiv .= " data='/senderos/app/webroot/sound/".$pointdocument['Document']['route']."' width='500' height='450'>";
				$imagesdiv .= "<param name='src' value='/senderos/app/webroot/sound/".$pointdocument['Document']['route']."'/>";
				$imagesdiv .= "<PARAM NAME='autoplay' VALUE='false' />";
				$imagesdiv .= "<EMBED id='snd".$pointdocument['Document']['id']."' name='snd".$pointdocument['Document']['id']."' SRC='/senderos/app/webroot/sound/".$pointdocument['Document']['route']."' AUTOPLAY='false' width='500' height='450'></EMBED>";
				$imagesdiv .= "</object><br>";
			}
			else if($pointdocument['Document']['type'] === 'text') //if a text
			{
				...
				$imagesdiv .="<div id='txt".$pointdocument['Document']['id']."' style='background-color: white; width:100%; height:100%;'>".$pointdocument['Document']['htmltext']."</div>";
			}
			else
			{
			}
